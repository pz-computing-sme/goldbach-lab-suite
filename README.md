...
```
Author: Vitor M. Pozza[space][space]
Research: Number Theory & Computational Heuristics[space][space]
Status: Heuristic Evidence for Mathematics Research[space][space]
